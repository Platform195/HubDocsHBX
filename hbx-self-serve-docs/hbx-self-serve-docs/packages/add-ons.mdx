---
title: "Add-ons"
description: "Extend a campaign with additional source markets and the Email Banner add-on."
---
...
<Tip>
  Add-ons update the campaign price in real time. Watch the **Total** on the
  campaign summary card as you toggle them on and off.
</Tip>
